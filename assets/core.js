...
class Component {
  ...
  constructor(el, context = {}) {
    ...
    this._eventHandler = new EventHandler/* default */.A();
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/components/SectionComponent.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/components/BlockComponent.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/components/ComponentManager.js
...
class ComponentManager {
   ...
   */
  awaitComponents(el, timeout = 5000) {
    const components = [];
    let componentEls = [];
    ...
    return new Promise(resolve => {
      ...
      const entry = {};
      entry.el = el;
      entry.callback = (newComponents = null) => {
        ...
        if (!componentEls.length) {
          clearTimeout(timer);
          this._awaitingComponents.splice(this._awaitingComponents.indexOf(entry), 1);
          resolve(components);
        }
      };
      timer = setTimeout(() => {
   ...
   *                          with a given name and tag, null if not found.
   */
  query(name, tag, scope = document.body) {
   ...
   *                          with a given name and tag, an empty array if none are found.
   */
  queryAll(name = '', tag = '', scope = document.body) {
    const componentSelector = name ? `[data-component="${name}"]` : '[data-component]';
    const tagSelector = tag ? `[data-component-tag="${tag}]` : '';
   ...
   * @private
   */
  _initializeComponents(name = null) {
   ...
   * @private
   */
  _onShopifyEvent(event, deferred = false) {
    const {
      target,
      type
    } = event;
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/a11y.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/Utils.js
...
class Utils {
   ...
   */
  scrollLock(element, scrollableElement, reserveScrollBarGap = true) {
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/Money.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/media/Model.js
/**
 * @class Model
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/media/YoutubeVideo.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/media/VimeoVideo.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/media/Html5Video.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/media/VideoPlayer.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/helpers/Media.js
...
;// ../../../../../tmp/paskit-KYBpQQ/scripts/core.js
/**
 * @module Core
 */
 ...
 * @see {@link https://github.com/pixelunion/events|Events}
 */
const Events = new EventHandler/* default */.A();
...
//# sourceMappingURL=core.js.map?1750107637904